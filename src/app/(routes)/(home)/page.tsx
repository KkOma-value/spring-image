    ...
    <div className="flex justify-center gap-2 sm:gap-4 mb-8">
      {[
        ...
        <button
          ...
          className={`px-4 py-2 sm:px-6 sm:py-2 rounded-full text-sm font-medium transition-all flex items-center gap-2 border ${appMode === mode
                ...
                <div className="flex bg-black/20 rounded-xl p-1 border border-white/10">
                  {(['1:1', '3:4', '16:9'] as const).map((ratio) => (
                    <button
                      ...
                      className={`px-4 py-3 rounded-lg text-sm font-medium transition-all ${aspectRatio === ratio
